    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 ">
            ...
            >
                ...
                />
                <div
                    className={`${characters < 1 ? "opacity-0" : "opacity-100"
                        }ms-auto flex justify-end mt-1 text-lg font-bold text-gray-600`}
                >
                    {characters}
                </div>

                <button
                    className={` w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover font-Ovo ${isFormValid
                            ? " cursor-pointer"
                            : "cursor-not-allowed"
                        } `}
                ...
                <div className="h-10">{isSending && <p className="text-center mt-4">sending...</p>}</div>
            </form>
